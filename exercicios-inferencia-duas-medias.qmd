---
title: "Comparar duas médias independentes: exercícios"
lang: pt-br
format: 
  html:
      toc: true
...
As atividades a seguir dizem respeito à comparação de duas médias. Para cada exercício, aplique os modelos matemático e computacional. Antes de realizar as análises inferenciais, explore os dados com estatísticas descritivas e gráficos para variável dependente em cada grupo da variável independente. Em seguida, relate os resultados adequadamente.
