...
Transforme o vetor sexo \<- c("M", "F", "F", "M", "F") em um fator. Em seguida, obtenha um resumo desse fator.
...
Cinco atletas participaram de uma corrida de 12 km e obtiveram os seguintes tempos (em minutos): 25.5, 30.2, 35.1, 40.8 e 45.9. Sabendo que a velocidade média é obtida dividindo a distância pela tempo, calcule a velocidade média de cada atleta em Km/h

## Exercício 18

Crie um objeto com 10 valores que tenham uma distribuição normal com média 7 e desvio padrão 2. Em seguida, obtenha um resumo estatístico dos valores.
