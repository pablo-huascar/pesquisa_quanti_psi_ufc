...
-   No slide a seguir, vamos ter as distribuições das seguintes variáveis
    ...
    -   Idade da morte de pessoas famosas (`Age of death`, do banco de dados `Age dataset: life, work, and death of 1.22M people`[^2])
...
histogramas_desvio_padrao |>  
  ...
  theme(legend.position = "none",
        plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5)) +
  scale_fill_manual(values = c("Desvio padrão menor" = "lightblue", 
                               "Desvio padrão maior" = "lightcoral")) +
  scale_color_manual(values = c("Desvio padrão menor" = "blue", 
                                "Desvio padrão maior" = "red"))
```
...
```{r}
#| label: boxplot-explicado
#| fig-width: 9.71

quantiles_sheight <-  quantile(father.son$sheight)
quantile(father.son$sheight, probs = c(0.15, 0.85))
median_sheight <- median(father.son$sheight)
points_quantile_sheight <- unname(breaks_box_plot_sheight)
...
box_plot_sheight <- box_plot_sheight +
  geom_segment(x = median_sheight, 
               xend = quantiles_box_plot_sheight[4], 
               y = 0.3, yend = 0.3, 
               arrow = arrow(length = unit(0.2, "cm"),
                             type = "closed"),
               color = "#EF7259") +
  geom_segment(x = median_sheight, 
               xend = quantiles_box_plot_sheight[2], 
               y = 0.3, yend = 0.3, 
               arrow = arrow(length = unit(0.2, "cm"),
                             type = "closed"), 
               color = "#EF7259") +
  annotate("text", x = quantiles_box_plot_sheight[4] + 0.5, y = 0.3,  
           label = "Intervalo interquartil", color = "#6682F3")
  
    
box_plot_sheight +
  geom_segment(x = quantiles_box_plot_sheight[4] + 4,
               xend = quantiles_box_plot_sheight[4], 
               y = 0.2, yend = 0.2, 
               arrow = arrow(length = unit(0.2, "cm"),
                             type = "closed"), 
               color = "#EF7259") +
  annotate("text", x = quantiles_box_plot_sheight[4] + 5, y = 0.2,
           label = "percentil 75", color = "#6682F3") +
  geom_segment(x = quantiles_box_plot_sheight[2] - 4,
               xend = quantiles_box_plot_sheight[2],
               y = 0.2, yend = 0.2, 
               arrow = arrow(length = unit(0.2, "cm"),
                             type = "closed"), 
               color = "#EF7259") +
  annotate("text", x = quantiles_box_plot_sheight[2] + -5, y = 0.2,
           label = "percentil 25", color = "#6682F3")
