...
-   Um gráfico de caixa resume um conjunto de dados usando cinco estatísticas e também identifica observações incomuns
    -   Mediana
...
box_plot_sheight <- box_plot_sheight + 
  ...
  annotate("text", label = "1.5 x intervalo interquartil",
           x = quantiles_sheight[2] - 2, y = -0.23,
           color = "#6682F3")
...
box_plot_sheight <- box_plot_sheight +
  ...
  annotate("text", x = median_sheight + 5, y = -0.2,
           label = "percentil 50 (mediana)", color = "#6682F3")
