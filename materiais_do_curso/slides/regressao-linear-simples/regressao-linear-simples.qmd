...
```{r}
#| label: tbl-cor-stats-bmass-flipper
#| tbl-cap: Estatísticas da correlação entre a massa corporal e o comprimento da nadadeira dos pinguins
#| tbl-cap-location: bottom

tbl_stats_cor_bmass_flipper <- cor.test(penguins$flipper_length_mm, 
         penguins$body_mass_g) |> 
  tidy() |> 
  select(estimate,t = statistic) |> 
  mutate(
...
-   Quais conclusões podemos tirar dessa equação?
    -   O sinal de b é positivo, portanto há uma relação positiva entre as variáveis
        ...
        -   Ou seja: um tamanho maior da nadadeira está associado a mairo massa corporal dos pinguins
