...
Quanto a lárgura da sépala (`Sepal.Width`) pode variar em função da espécie de flor (`Species`)? Para simplificar a explicação, vamos trabalhar somente com as espécies versicolor e setosa
