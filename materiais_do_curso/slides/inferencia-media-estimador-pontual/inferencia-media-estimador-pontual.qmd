...
amostras_price_diamonds |> 
  ...
  labs(
    x = "Médias",
    title = "Histograma das médias de 1000 amostras dos preços de 30 diamantes"
  ) +
  theme(
...
## Média da distriuição amostral das médias amostrais: $\bar{X}$
...
## Erro padrão: o desvio padrão das distribuições amostrais
