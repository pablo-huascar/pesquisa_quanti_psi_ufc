...
::: {.fragment .fade-up}
![](img/Rlogo%20(1)-02.png){width="298"}
:::

::: {.fragment .fade-right}
![](img/rstudio-logo-flat-02.png){width="760"}
:::
...
-   [Dica: crie uma pasta projetos_r dentro da pasta "C:" do Windows e, dentro dela, crie sub pastas para cada projeto]{style="font-size:20pt;"}
:::
:::::
...
::::: columns
::: {.column width="50%"}
![](img/rstudio-ide-1.png)
:::

::: {.column width="50%"}
![](img/rstudio-ide-2.png)
:::
:::::
...
::: {.column width="50%"}
[![](img/r_for_d_s.jpg){fig-alt="Capa do livro R for Data Science. Uma coruja se destaca na ilustração" fig-align="right" width="412"}](https://r4ds.had.co.nz/)
:::
:::::
...
-   E [aqui](https://r4ds.hadley.nz/ "R for Data Science") você pode acessar a segunda edição:
