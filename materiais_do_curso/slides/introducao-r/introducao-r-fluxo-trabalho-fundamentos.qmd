...
## Condificação básica {.center transition="fade-in fade-out" transition-speed="slow"}

## Painéis do R Studio: console
...
## Todas as instruções de atribuição têm o mesmo formato {.smaller}
