...
-   Dependência do environment: como iniciante, é comum depender do environment para armazenar os objetos criados durante a análise
-   Scripts como fonte de verdade: para facilitar trabalhos maiores ou colaboração, seus scripts r devem ser a fonte de verdade\
-   Recriação do ambiente: com seus scripts e arquivos de dados, você pode recriar todo o ambiente facilmente\
-   Dificuldade sem scripts: dependendo apenas do environment, é difícil recriar os scripts:
