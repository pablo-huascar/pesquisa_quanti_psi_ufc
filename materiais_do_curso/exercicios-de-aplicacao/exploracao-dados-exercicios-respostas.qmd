...
tmcs_assedio_moral |> 
  ...
  gt() |> 
  fmt_percent(
    columns = prop, decimals = 1
    ) |> 
  cols_align(columns = c(n, prop),
    align = "center"  
  ) |> 
  cols_label(
    value = "Variável",
...
#### TMCs e assedio moral profissional
...
#### TMCs e tempo de experiência como professor
