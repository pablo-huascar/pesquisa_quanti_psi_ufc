...
![](img/teste-t-grupo-leitor.png){.absolute width="300" top="170" left="0"}
![](img/linha-vertical.png){.absolute width="200" down="300" right="450"}
![](img/teste-t-grupo-nao-leitor.png){.absolute width="300" top="170" right="0"}
<div class="absolute" style="top: 480px; left: 0px; width: 250px; text-align: center; font-weight: bold; font-size: 32px;">
Grupo leitor
</div>

<div class="absolute" style="top: 480px; right: 25px; width: 250px; text-align: center; font-weight: bold; font-size: 32px;">
Grupo não Leitor
</div>
