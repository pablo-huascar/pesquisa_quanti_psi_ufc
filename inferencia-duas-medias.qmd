...
# Modelo matemático para testar e estimar a diferença entre médias: teste t para amostras independentes {style="font-size: 22pt;"}

## Exemplo {.smaller}

-   Há diferença no consumo de combustível entre carros com motores em V e retos?
-   Hipóteses (Bilateral):
...
#| echo: true
#| eval: false
leveneTest(VD ~ VI, center = "median", dados)
```
