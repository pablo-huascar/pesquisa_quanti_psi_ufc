...
-   Hipóteses (Bilateral):
    -   $$H_0$$: a média do consumo de combustível dos carros com motores em V é igual à média dos carros com motores retos
        -   $$H_0: \mu_{\text{V}} = \mu_{\text{reto}}$$
    -   $$H_a$$: a média do consumo de combustível dos carros com motores em V-shaped é diferente da média dos carros com motores straight
        -   $$H_a: \mu_{\text{V}} \ne \mu_{\text{reto}} $$
